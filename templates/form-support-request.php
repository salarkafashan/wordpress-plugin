				...
				<form class="kgr-form" data-kgr-form novalidate autocomplete="off">
					...
					<section class="kgr-step" data-step-key="validation" aria-hidden="true">
						...
						<div class="kgr-actions">
							<button type="button" class="kgr-btn kgr-btn--secondary"
								data-action="back"><img src="<?php echo esc_url(KGR_PLUGIN_URL . 'assets/img/back.svg'); ?>" alt="" aria-hidden="true" class="kgr-btn__icon kgr-btn__icon--before" /><?php esc_html_e('Back', 'knaguru-support'); ?></button>
							<button type="button" class="kgr-btn kgr-btn--primary" data-action="next">
								<span class="kgr-btn__spinner kgr-hidden" data-next-spinner></span>
								<span data-next-label><?php esc_html_e('Next', 'knaguru-support'); ?></span>
								<img src="<?php echo esc_url(KGR_PLUGIN_URL . 'assets/img/next.svg'); ?>" alt="" aria-hidden="true" class="kgr-btn__icon kgr-btn__icon--after" />
					...
					<section class="kgr-step" data-step-key="contact" aria-hidden="true">
						...
						<div class="kgr-field">
							...
							<input id="kgr_email" name="email" type="email" data-error-key="email" autocomplete="email" placeholder="<?php esc_attr_e('Your email address', 'knaguru-support'); ?>"
								x-model='email' />
						...
						<div class="kgr-grid kgr-grid--two">
							<div class="kgr-field">
								...
								<input id="kgr_first_name" name="first_name" type="text" data-error-key="first_name" placeholder="<?php esc_attr_e('First name', 'knaguru-support'); ?>"
									autocomplete="given-name" x-model='first_name' />
								<p class="kgr-error" data-field-error-for="first_name" id="error_first_name"></p>
							</div>
							<div class="kgr-field">
								
								<input id="kgr_last_name" name="last_name" type="text" data-error-key="last_name" placeholder="<?php esc_attr_e('Last name', 'knaguru-support'); ?>"
						...
						<p class="kgr-hint kgr-hidden" data-kgr-qa-hint data-kgr-qa-hint-website>
							<?php esc_html_e('QA Hint: You can enter your own email address here. (the Email set in admin settings will receives admin notifications)', 'knaguru-support'); ?>
						</p>
						<p class="kgr-hint kgr-hidden" data-kgr-qa-hint data-kgr-qa-hint-website>
							<?php esc_html_e('Workflow: if this email matches the WHMCS owner email, confirmation is sent to this address immediately. If it does not match, confirmation is sent to the WHMCS owner email on record.', 'knaguru-support'); ?>
						</p>
						<div class="kgr-actions">
							<button type="button" class="kgr-btn kgr-btn--secondary"
								data-action="back"><img src="<?php echo esc_url(KGR_PLUGIN_URL . 'assets/img/back.svg'); ?>" alt="" aria-hidden="true" class="kgr-btn__icon kgr-btn__icon--before" /><?php esc_html_e('Back', 'knaguru-support'); ?></button>
			...
			<div class="kgr-issue-card" data-issue-card>
				...
				<div class="kgr-field">
					<input type="text" data-issue-field="page_url"
						placeholder="<?php esc_attr_e('Which page is this on? e.g., /contact-us or homepage', 'knaguru-support'); ?>" />
				...
				<div class="kgr-grid kgr-grid--two">
					<div class="kgr-field">
						<select data-issue-field="issue_type">
							<option value=""><?php esc_html_e('What type of issue?', 'knaguru-support'); ?></option>
					...
					<div class="kgr-field">
						<select data-issue-field="urgency">
							<option value=""><?php esc_html_e('How urgent is this?', 'knaguru-support'); ?>
							</option>
							<option value="Low"><?php esc_html_e('Low', 'knaguru-support'); ?>
							</option>
							<option value="Medium">
								<?php esc_html_e('Medium', 'knaguru-support'); ?>
							</option>
							<option value="High"><?php esc_html_e('High', 'knaguru-support'); ?>
							</option>
						</select>
				...
				<div class="kgr-field kgr-hidden" data-issue-conditional="content_change">
					<textarea data-issue-field="change_details"
						placeholder="<?php esc_attr_e('What needs to be changed? e.g., Change the phone number in the footer to...', 'knaguru-support'); ?>"></textarea>
				...
				<div class="kgr-field kgr-hidden" data-issue-conditional="image_replacement">
					<textarea data-issue-field="image_details"
						placeholder="<?php esc_attr_e('Which image should we replace? e.g., The main banner image on the homepage...', 'knaguru-support'); ?>"></textarea>
				...
				<div class="kgr-field" data-issue-conditional="description">
					<textarea data-issue-field="description"
						placeholder="<?php esc_attr_e('Tell us more about the problem e.g., When I click the button, nothing happens...', 'knaguru-support'); ?>"></textarea>
